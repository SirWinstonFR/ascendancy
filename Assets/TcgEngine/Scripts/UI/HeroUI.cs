...
namespace TcgEngine.UI
{
    ...
    public class HeroUI : MonoBehaviour
    {
        ...
        public Text power_mana;
		  ...
		  // --- NOUVEAU : image du héros ---
        public Image hero_image;  // <<< image de portrait du héros
        ...
        private void Update()
        {
            ...
            if (hero == null)
              ...
              // --- NOUVEAU : mettre à jour l’image du héros ---
            if (heroCard != null)
            {
                heroCard.GetComponent<SpriteRenderer>().sprite = hero.CardData.GetFullArt(hero.VariantData);
				heroCard.transform.localScale = new Vector3(0.2f, 0.2f, 0.1f);
			}
